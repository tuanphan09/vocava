...
import com.bit.vocava.callback.OnCustomTouchListener;
...
public class PhotorTool {
    ...
    public static void sendEmailMoree(Context context, String[] addresses, String subject,
                                      String body) {
        disableExposure();
    ...
    public static void clickScaleView(final View view,
        ...
        setOnCustomTouchView(view, new OnCustomTouchListener() {
            ...
            public void OnCustomTouchUp(View v, MotionEvent event) {
                setScale(1f);
                if (customClickListener != null) customClickListener.OnCustomClick(v, event);
            }
    ...
    public static void setOnCustomTouchView(final View view,
                                            final OnCustomTouchListener onCustomTouchListener) {
        view.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                } else if (rect != null && !rect.contains(v.getLeft() + (int) event.getX(),
    ...
    public static boolean checkHasPermission(Activity activity) {
        ...
        hasPermission =
                isPermissionAllow(activity, Manifest.permission.READ_EXTERNAL_STORAGE) && isPermissionAllow(
    ...
    private static boolean isPermissionAllow(Activity activity, String permission) {
        if (PhotorTool.getSdkVersion() < 23) return true;
